...
Class UTPlayer : PlayerPawn
{
	...
	void DashInitiator()
	{
		...
		if(WaterLevel >= 2 || bNOGRAVITY || ZMPlayer.CrouchFactor != 1 || LedgeGrabbed || CeilingZ - FloorZ <= Height)
		{
			CheckForWJump = 0;
			Return;
		}
	...
	void BobWeaponAuxiliary()
	{
		...
		Bool  InTheAir = Jumped || abs(FloorZ - Pos.Z) > 16 || InTheAirNoOffset || (DashCooler > 13 && DashCooler <= 100);
