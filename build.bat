...
TITLE Team Raycast Mods Compiler - Thanks SibTiger!
...
IF %featuresGit% NEQ True (
    ...
    IF "%projectName%" NEQ "batmod" SET "projectName=batmod"
    GOTO :EOF
)
...
REM Avoid redundancy
IF "%projectName%" NEQ "batmod-%GitCommitHash%" SET "projectName=batmod-%GitCommitHash%"
GOTO :EOF
...
REM #     However, first make sure that the Git dependency is available on the host.
REM # ================================================================================================
